          ...
          >
            ...
            <div className="grid grid-cols-12 gap-4 mb-4">
              ...
              >
                ...
                <option value="tiny" defaultValue={`tinyurl.com`}>
                  tinyurl.com
                </option>
              </select>
        ...
        {copyMe && (
          <div className="bg-white p-10 rounded-xl w-[90%] max-w-[476px] mx-auto my-auto">
            <div className="font-medium text-lg mb-4">
              Your long URL is:{' '}
              <a href={long_url} target="_blank" rel="noopener noreferrer" className="text-primary">
                {long_url}
              </a>
            </div>
            <div className="font-medium text-lg mb-2">
              Your Shortened URL is:{' '}
              <a href={`https://tinyurl.com/${customUrl}`} 
