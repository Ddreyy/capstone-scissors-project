    ...
    <Layout>
      {/* {loading ? (
        <div className="bg-gray-200 h-full md:h-[calc(100vh_-_60px)] overflow-y-auto">
          <div className="flex mt-8 h-full bg-white rounded-lg justify-center items-center">
            <CircleLoader color="#005AE2" />
          </div>
        </div>
      ) : ( */}
        <div className="flex justify-center items-center h-full">
          <div className="font-bold font-kanit text-primary text-4xl text-center mx-8">
            {text}
          </div>
          {/* <div>
