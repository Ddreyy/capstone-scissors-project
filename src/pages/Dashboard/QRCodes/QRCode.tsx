...
//             {
//                 url: long_url,
//                 custom_alias: custom_url // If you want to specify a custom alias
//             },
//             {
//                 headers: {
...
//             warn(`An error occurred: ${axiosError.message}`);
//         } else {
...
//               <option value="tiny" defaultValue={`api.tinyurl.com`}>
//                 api.tinyurl.com
//               </option>
//             </select>
...
//                 <a
//                   href={`https://api.tinyurl.com/${shortUrl}`}
//                   target="_blank"
//                   rel="noopener noreferrer"
//                   className="text-primary"
//                 >
//                   https://api.tinyurl.com/{shortUrl}
//                 </a>
//               </div>
//               <div className="font-medium text-lg mb-2">
//                 Your customized link is:{' '}
//                 <a
//                   href={`https://api.tinyurl.com/${customUrl}`}
//                   target="_blank"
//                   rel="noopener noreferrer"
//                   className="text-primary"
//                 >
//                   https://api.tinyurl.com/{customUrl}
//                 </a>
//               </div>
//             </>
//           )}
